...
Tree.prototype.map = function(callback,child = new Tree(callback(this.value))) {
  // TODO: return a new tree with the same structure as `this`,
  //       with values generated by the callback
  for(var i = 0;i<this.children.length;i++) {
  	child.addChild(callback(this.children[i].value))
  	this.children[i].map(callback,callback(this.children[i].value))
  }
  return child
};
